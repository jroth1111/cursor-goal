...
function decomposePrompt(spec: GoalSpec): string {
  ...
  return [
    ...
    "Decompose so the finished work has: real edge-case handling, clear error paths, a",
    "meaningful test suite (not just happy-path), and complete usage docs. Include explicit",
    "tasks for tests, hardening/edge-cases, and documentation even if the goal didn't name them.",
    "",
    "Rules:",
